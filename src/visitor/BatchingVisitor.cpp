...
void SpecialBatchingVisitor::visit(BinaryExpression &elem) {
...
void SpecialBatchingVisitor::visit(UnaryExpression &elem) {
...
void SpecialBatchingVisitor::visit(Variable &elem) {
...
void SpecialBatchingVisitor::visit(Function &elem) {
  enterScope(elem);
...
void SpecialBatchingVisitor::visit(ExpressionList &elem) {
...
void SpecialBatchingVisitor::visit(Return &elem) {
  if (elem.hasValue()) {
    elem.getValue().accept(*this);
    if (replacementExpression) {
...
void SpecialBatchingVisitor::visit(For &elem) {
...
void SpecialBatchingVisitor::leftForLoop() {
  if (currentLoopDepth_maxLoopDepth.first==1) {
...
void SpecialBatchingVisitor::enteredForLoop() {
...
bool SpecialBatchingVisitor::isUnrollLoopAllowed() const {
...
SpecialBatchingVisitor::identifyReadWriteVariables(For &forLoop) {
...
std::unique_ptr<VariableDeclaration> SpecialBatchingVisitor::generateVariableDeclaration(const ScopedIdentifier &variable,
                                                                                                      AbstractNode *parent) {
...
std::unique_ptr<Assignment> SpecialBatchingVisitor::generateVariableAssignment(const ScopedIdentifier &variable,
                                                                                            AbstractNode *parent) {
...
//void BatchingVisitor::visit(Rotate &elem) {
//  Visitor::visit(elem);
...
//}
//
//void BatchingVisitor::visit(Transpose &elem) {
//  Visitor::visit(elem);
...
//}
//
//void BatchingVisitor::visit(MatrixAssignm &elem) {
...
//}
//
//void BatchingVisitor::visit(MatrixElementRef &elem) {
//  Visitor::visit(elem);
...
//}
//
//void BatchingVisitor::visit(GetMatrixSize &elem) {
//  Visitor::visit(elem);
//
...
//// =====================
//
//void BatchingVisitor::visit(VarDecl &elem) {
...
//}
//
//void BatchingVisitor::visit(VarAssignm &elem) {
//  Visitor::visit(elem);
//  // store the variable's value
...
//}
//
//void BatchingVisitor::visit(OperatorExpr &elem) {
...
//}
//
//void BatchingVisitor::simplifyLogicalExpr(OperatorExpr &elem) {
...
//}
//
//void BatchingVisitor::visit(Block &elem) {
//  Visitor::visit(elem);
//  cleanUpBlock(elem);
//
...
//}
//
//void BatchingVisitor::visit(Call &elem) {
...
//}
//
//void BatchingVisitor::visit(If &elem) {
...
//}
//
//void BatchingVisitor::visit(While &elem) {
...
//}
//
////AbstractNode *BatchingVisitor::doPartialLoopUnrolling(For &elem) {
...
//// =====================
//
//AbstractExpression *BatchingVisitor::generateIfDependentValue(
...
//}
//
//void BatchingVisitor::appendVectorToMatrix(const std::string &variableIdentifier, int posIndex,
...
//}
//
//void BatchingVisitor::setMatrixVariableValue(const std::string &variableIdentifier,
//                                                             int row,
//                                                             int column,
...
//}
//
//void BatchingVisitor::emitVariableDeclaration(ScopedVariable variableToEmit) {
